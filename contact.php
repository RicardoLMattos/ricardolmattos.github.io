...
<head>
    <meta charset="utf-8" />
    <title>Ricardo Leonardo Matos da Silva</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Ricardo Leonardo Matos da Silva" />
    <meta name="description"
        content="Portifólio de trabalhos realizados e formação de Ricardo Leonardo Matos da Silva" />
    <!-- Styles -->
        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.png"
                            alt="Ricardo Leonardo Matos da Silva">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Ricardo Leonardo Matos da Silva</h4>
                        ...
                        <ul class="header__social">
                            ...
                            <li>
                                <a href="https://github.com/RicardoLMattos">
                    ...
                    <ul class="header__contact">
                        ...
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=55xxxxxxxxxxx">+55 (99) 99999-9999 </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Ricardo Leonardo Matos da Silva </footer>
                </div>
            </div>
        </div>
    </main>
